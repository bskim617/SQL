...
insert into `Customer` values ('c106', '정렬', '010-1234-1006', '경기도 용인시', '2022-01-06');
...
#실습1-17 입력되지 않는 값만 = is null  null 값만
SELECT * FROM `Customer` WHERE `hp` is null;

#실습1-18 입력된 값만 = is not null null값을 빼고
...
where substr(`orderDate`, 1, 10) = '2022-07-03'; #문자열 짜르기 like 써도 됨
